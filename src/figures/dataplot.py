...
tss1 = []
for det in dets:
    tte_file = "gbm_files/glg_tte_{}_bn120711115_v00.fit".format(det)
    rsp2_file="gbm_files/glg_cspec_{}_bn120711115_v00.rsp2".format(det)
...
lgd = f.legend(loc='center left', bbox_to_anchor=(1, 0.6), labels=["SPI Det13 Model", "SPI Det14 Model", "SPI Det16 Model",
                                                                    "GBM NaI-4 Model","SPI Det13 Data", "SPI Det14 Data",
                                                                    "SPI Det16 Data", "GBM NaI-4 Data"])
