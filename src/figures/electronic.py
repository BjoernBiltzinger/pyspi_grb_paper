...
ax.step(ebounds[1:], counts_psd, color=color1)
ax.step(ebounds[1:], counts_non_psd, color=color2)
ax.fill_betweenx(np.linspace(0,np.max(counts_non_psd),10), 400, 2700, alpha=0.3, color=color3)
ax.fill_betweenx(np.linspace(0,np.max(counts_non_psd),10), 1400, 1900, alpha=0.5, color=color3)
ax.set_yscale("log")
ax.set_xscale("log")
