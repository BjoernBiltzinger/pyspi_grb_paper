...
\begin{figure}
  \begin{centering}
    ...
    \caption{Corner plot for the Band function fit to the SPI data with {\tt PySPI} and {\tt OSA}.  The results are in agreement, but {\tt PySPI} constrains the parameters more precisely.}
...
\begin{figure*}
  \begin{centering}
    ...
    \caption{Data and best fit model in count space for three of the SPI detectors and one of the NaI (BGO) detectors of GBM in the upper (lower) plot. The spectral model for this fit was a physical synchrotron model.}
    \label{fig:dataplot}
  \end{centering}
\end{figure*}
