...
\begin{figure}
  \begin{centering}
    \begin{subfigure}[b]{1\textwidth}
      \begin{centering}
        \includegraphics{figures/spi_lightcurve_ts.pdf}
        \caption{Light curve for SPI detector 0 and GRB120711A.}
        \label{fig:ts_spi}
      \end{centering}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{1\textwidth}
      \begin{centering}
        \includegraphics{figures/gbm_lightcurve_ts.pdf}
        \caption{Light curve for GBM detector n2 and GRB120711A.}
        \label{fig:ts_gbm}
      \end{centering}
    \end{subfigure}
  \end{centering}
