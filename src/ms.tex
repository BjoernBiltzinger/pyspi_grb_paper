...
\begin{figure}
  \begin{centering}
    ...
    \caption{Corner plot for the SPI fit with PySPI and the official tools. The spectral model is a band function. The results are in agreement, but PySPI can constrain the parameters better.}
  \end{centering}
\end{figure}
