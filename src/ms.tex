...
All the fits in this section are done with 3ML and the Bayesian sampling algorithm MultiNest to create full posterior distributions of the parameters. To visualize the posterior distribution we use ChainConsumer with the output from MultiNest to create corner plots.
